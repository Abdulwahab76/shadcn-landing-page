      ...
      <div className="grid place-items-center lg:max-w-screen-xl gap-8 mx-auto py-20 ">
        <div className="text-center space-y-8">
          ...
          <div className="max-w-screen-md mx-auto text-center text-4xl md:text-6xl font-bold">
            <h1>
              Best Digital  <span className="text-transparent px-2 bg-gradient-to-r from-[#D247BF] to-primary bg-clip-text">
                Marketing
              </span> Services to Grow Your
          ...
          <div className="space-y-4 md:space-y-0 md:space-x-4">
            <Link href='#contact'> <Button className="w-5/6 md:w-1/4 font-bold group/arrow">
              Get Started
